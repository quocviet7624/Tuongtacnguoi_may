...
class CandidateDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = candidate.fullName.isNotEmpty ? candidate.fullName : candidate.email;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Hồ sơ ứng viên',
          style: TextStyle(
              color: Color(0xFF1F2937), fontSize: 17, fontWeight: FontWeight.bold),
        ),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            ...
            _Section(
              ...
              children: [
                _Row(icon: Icons.school_outlined, label: 'Trường', value: candidate.school ?? 'Chưa cập nhật'),
                _Row(icon: Icons.book_outlined, label: 'Ngành', value: candidate.major ?? 'Chưa cập nhật'),
                      ...
                      children: candidate.skills!.map((skill) {
                        return Container(
                          ...
                          child: Text(
                            skill,
                            style: const TextStyle(
                                fontSize: 13, color: Color(0xFF0369A1), fontWeight: FontWeight.w500),
                          ),
                        );
                      }).toList(),
                    ),
              ...
              _Section(
                ...
                children: [
                  _Row(
                    ...
                    label: 'Mức lương',
                    value: _formatSalary(candidate.salaryMin, candidate.salaryMax),
                  ),
                  if (candidate.availableTime != null && candidate.availableTime!.isNotEmpty)
                    _Row(
            ...
            _Section(
              ...
              children: [
                _Row(icon: Icons.work_outline, label: 'Vị trí', value: job.title),
                _Row(icon: Icons.business_outlined, label: 'Công ty', value: job.company),
                _Row(icon: Icons.location_on_outlined, label: 'Địa điểm', value: job.location),
                _Row(icon: Icons.attach_money, label: 'Lương', value: job.salary),
              ],
            ),
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () => _showInterviewDialog(context, displayName),
  ...
  void _showInterviewDialog(BuildContext context, String name) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Chức năng đặt lịch phỏng vấn. Bạn muốn xem lịch phỏng vấn?'),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            ...
            child: const Text('Xem lịch', style: TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
